...
Tela e ViewModel: skill `screen-mvvm-architecture`. Copy/labels: skill `screen-helpers` (ModelsBuilder). Testes: skill `widget-testing`.
...
- Tokens do DS só no component (e no `build` da screen), não no ViewModel.
